 ...
 * 看成任何数字,并且A看作1,J为11,Q为12,K为13。上面的5张牌就可以变成“1,2,3,4,5”(大小王分别看作2
 * 和4),“So Lucky!”。LL决定去买体育彩票啦。
 *
 * 现在,要求你使用这幅牌模拟上面的过程,然后告诉我们LL的运气如何， 如果牌能组成顺子就输出true，否则就
...
public class Main45 {
    ...
    public static boolean isContinuous(int [] numbers) {
        ...
        while(i < numbers.length - 1) {
            if(numbers[i + 1] - numbers[i] > zeroNum + 2 ||
